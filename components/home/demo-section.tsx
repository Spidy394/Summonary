    ...
    <section className="relative">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          <div className="inline-flex items-center justify-center p-2 rounded-2xl bg-white/5 backdrop-blur-sm border border-gray-500/20 mb-4">
            <Pizza className="size-6 text-rose-500" />
          </div>
          <h3 className="font-bold text-3xl max-w-2xl mx-auto px-4 sm:px-6">
            Watch how Summonary transforms
            <span className="bg-gradient-to-r from-rose-500 to-rose-700 bg-clip-text text-transparent">
              {" "}
              your PDFs{" "}
            </span>
            into easy-to-read summary.
          </h3>
        </div>
        <div className="flex justify-center items-center px-2 sm:px-4 lg:px6">
          {/* Summary Viewer */}
        </div>
      </div>
    </section>
